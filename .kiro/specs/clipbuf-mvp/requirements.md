...
5. When ユーザーが項目のテキストにポインタを一定時間とどめる, the clipbuf shall その項目の全文プレビューを表示する
5.1. While ポインタが項目の上を通過しているだけである, the clipbuf shall 全文プレビューを表示しない
...
10.1. The clipbuf shall 全文プレビューの左上を、対象の項目の行の左下に合わせ、行そのものは隠さない
10.2. The clipbuf shall 全文プレビューがウィンドウの右下から一定の余白を残す範囲に収まるようにし、収まらない場合は記憶している大きさを縮めて収める
